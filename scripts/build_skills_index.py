#!/usr/bin/env python3
"""Build the Gengar Skills Index — a centralized JSON catalog of all skills.
...
`gengar skills search/install` can use it without hitting the GitHub API.
...
# Ensure GENGAR_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Gengar Skills Index...", flush=True)
