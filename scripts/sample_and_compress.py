...
DEFAULT_DATASETS = [
    "jamesfincher/swe-terminus-agent-glm-kimi-minimax",
    "jamesfincher/gengar-megascience-sft1",
    "jamesfincher/Gengar-Thinking-GLM-4.7-SFT2",
    "jamesfincher/Gengar-Thinking-GLM-4.7-SFT1",
    "jamesfincher/terminal-tasks-glm-gengar"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "jamesfincher/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload jamesfincher/{output_name} {final_output}")
