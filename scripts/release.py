...
AUTHOR_MAP = {
    ...
    "teknium@jamesfincher.com": "teknium1",
    ...
    "274096618+gengar-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@jamesfincher.com": "shannonsands",
    ...
    "gengar@jamesfincher.com": "jamesfincher",
    ...
    "ben@jamesfincher.com": "benbarclay",
    ...
    "emozilla@jamesfincher.com": "emozilla",
    ...
    "jonny@jamesfincher.com": "jquesnelle",
    ...
    "gengar@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "gengar@jamesfincher.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/jamesfincher/gengar",
    ...
    lines.append(f"# Gengar v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Gengar. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Gengar Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Gengar Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Gengar v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Gengar v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Gengar v{new_version} ({calver_date})' "
