#!/usr/bin/env python3
"""Build the Gengar Model Catalog — a centralized JSON manifest of curated models.
...
Gengar CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Gengar release.
...
# Ensure GENGAR_HOME is set for imports that touch it at module level.
os.environ.setdefault("GENGAR_HOME", os.path.join(os.path.expanduser("~"), ".gengar"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "gengar repo",
            "docs": "https://github.com/jamesfincher/gengar/tree/main/website/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
