# Gengar Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.gengar/plugins/gengar-achievements/state.json` (existing unlock state)
  - `~/.gengar/plugins/gengar-achievements/scan_snapshot.json` (new)
  - `~/.gengar/plugins/gengar-achievements/scan_checkpoint.json` (new)
