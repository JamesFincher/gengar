# Gengar Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.gengar/plugins/gengar-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.gengar/plugins/gengar-achievements/scan_checkpoint.json`.
