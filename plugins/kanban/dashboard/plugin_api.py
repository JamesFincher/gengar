...
class UpdateTaskBody(BaseModel):
    ...
    # transitions to 'done'. Dashboard parity with ``gengar kanban
...
@router.get("/config")
def get_config():
    """Return kanban dashboard preferences from ~/.gengar/config.yaml.
...
def get_assignees():
    ...
    Returns the union of ``~/.gengar/profiles/*`` on disk and every
