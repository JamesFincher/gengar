...
Config: ~/.gengar/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.gengar/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (GENGAR_HOME-aware and
