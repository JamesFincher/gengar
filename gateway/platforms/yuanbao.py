...
try:
    ...
    _GENGAR_VERSION = "0.0.0"

_APP_VERSION = _GENGAR_VERSION
_BOT_VERSION = _GENGAR_VERSION
_YUANBAO_INSTANCE_ID = str(GENGAR_INSTANCE_ID)  # single source: yuanbao_proto.GENGAR_INSTANCE_ID
