...
const config: Config = {
  ...
  url: 'https://gengar.jamesfincher.com',
  baseUrl: '/docs/',

  organizationName: 'jamesfincher',
  projectName: 'gengar',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/jamesfincher/gengar/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://gengar.jamesfincher.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/jamesfincher/gengar',
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://github.com/jamesfincher/gengar' },
            { label: 'GitHub Discussions', href: 'https://github.com/jamesfincher/gengar/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/jamesfincher/gengar' },
            { label: 'James Fincher', href: 'https://github.com/jamesfincher' },
          ],
        },
      ],
      copyright: `Built by <a href="https://github.com/jamesfincher">James Fincher</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
