...
| [`gengar`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-gengar) | Configure, extend, or contribute to Gengar. | `autonomous-ai-agents/gengar` |
...
| [`kanban-worker`](/docs/user-guide/skills/bundled/devops/devops-kanban-worker) | Pitfalls, examples, and edge cases for Gengar Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper det... | `devops/kanban-worker` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-gengar-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-gengar-tui-commands) | Debug Gengar TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-gengar-tui-commands` |
| [`gengar-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-gengar-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/gengar-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .gengar/plans/, no exec. | `software-development/plan` |
