...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Gengar — schemas, handlers, registration, and toolsets"
---
...
2. **`toolsets.py`** — add tool name to `_GENGAR_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `gengar chat -q "Use the weather tool for London"`
