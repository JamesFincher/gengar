...
Gengar tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Gengar resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`gengar-cli`, `gengar-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `gengar-acp`
