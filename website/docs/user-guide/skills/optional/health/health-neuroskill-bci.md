...
| | |
|---|---|
| Source | Optional — install with `gengar skills install official/health/neuroskill-bci` |
...
Connect Gengar to a running [NeuroSkill](https://neuroskill.com/) instance to read
