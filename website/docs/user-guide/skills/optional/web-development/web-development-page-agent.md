...
- User wants **Gengar itself to drive a browser** → use Gengar' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
