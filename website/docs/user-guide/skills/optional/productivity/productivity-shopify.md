...
| | |
|---|---|
| Source | Optional — install with `gengar skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Gengar","productType":"Apparel","tags":["test"]}}'
```
