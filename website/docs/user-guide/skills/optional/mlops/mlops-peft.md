...
| | |
|---|---|
| Source | Optional — install with `gengar skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/jamesfincher/gengar/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/jamesfincher/gengar/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
