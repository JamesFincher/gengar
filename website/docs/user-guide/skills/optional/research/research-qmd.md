...
| | |
|---|---|
| Source | Optional — install with `gengar skills install official/research/qmd` |
...
Gengar via the native MCP client. This is the preferred
...
Then configure Gengar to connect via HTTP:
