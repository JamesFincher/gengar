...
Set your Tenor API key in your environment (add to `~/.gengar/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/jamesfincher/gengar/blob/main/skills/media/gif-search/url)`
