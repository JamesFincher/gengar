...
```bash
python3 -m pyfiglet "GENGAR" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=GENGAR&font=Slant" | boxes -d stone
```
