...
```python
import sys
sys.path.insert(0, "/home/teknium/.gengar/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.gengar/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Gengar installs package this)
