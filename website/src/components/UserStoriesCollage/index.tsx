  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Gengar community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Gengar &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Gengar?{' '}
        <a
          href="https://github.com/jamesfincher/gengar/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/jamesfincher/gengar" target="_blank" rel="noopener noreferrer">
          James Fincher Discord
        </a>{' '}
