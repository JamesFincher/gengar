...
class TestBlockingApprovalE2E:
    ...
    def setup_method(self):
        ...
        os.environ.pop("GENGAR_GATEWAY_SESSION", None)
        os.environ.pop("GENGAR_EXEC_ASK", None)
        os.environ.pop("GENGAR_SESSION_KEY", None)
    ...
    def test_blocking_approval_approve_once(self):
        ...
        def agent_thread():
            ...
            os.environ["GENGAR_SESSION_KEY"] = session_key
            try:
...
class TestFallbackNoCallback:
    ...
    def test_no_callback_returns_approval_required(self):
        ...
        os.environ["GENGAR_EXEC_ASK"] = "1"
        os.environ["GENGAR_SESSION_KEY"] = "no-callback-test"
        try:
