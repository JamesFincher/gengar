...
being persisted to ~/.gengar/discord_threads.json.
"""
...
class TestDiscordThreadPersistence:
    ...
    def _make_adapter(self, tmp_path):
        """Build a minimal DiscordAdapter with GENGAR_HOME pointed at tmp_path."""
    ...
    def test_missing_hermes_home_does_not_crash(self, tmp_path):
        ...
        with patch.dict(os.environ, {"GENGAR_HOME": str(fake_home)}):
