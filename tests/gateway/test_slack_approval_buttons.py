...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "gengar_approve_once" in action_ids
        assert "gengar_approve_session" in action_ids
        assert "gengar_approve_always" in action_ids
        assert "gengar_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "gengar_deny", "value": "session-key"}
