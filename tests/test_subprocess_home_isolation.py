...
See: https://github.com/jamesfincher/gengar/issues/4426
"""
...
class TestGetSubprocessHome:
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("GENGAR_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("GENGAR_HOME", str(base / "beta"))
