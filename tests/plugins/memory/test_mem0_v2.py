...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "gengar"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "gengar"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_gengar_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "gengar-user"
    ...
    def test_default_agent_id_hermes(self, monkeypatch, tmp_path):
        ...
        assert provider._agent_id == "gengar"
