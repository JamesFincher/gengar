...
class TestGengarParser:
    @pytest.fixture
    def parser(self):
        return get_parser("gengar")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["gengar"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use gengar format since that's universal
