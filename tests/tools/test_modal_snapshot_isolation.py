...
def _restore_tool_modules():
    original_hermes_home = os.environ.get("GENGAR_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_hermes_home is None:
            ...
            os.environ["GENGAR_HOME"] = original_hermes_home
...
def _install_modal_test_modules(
    ...
    *,
    ...
    os.environ["GENGAR_HOME"] = str(hermes_home)
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="gengar", create_if_missing=create_if_missing)
