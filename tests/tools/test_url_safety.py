...
class TestGlobalAllowPrivateUrls:
    ...
    def test_default_is_false(self, monkeypatch):
        ...
        monkeypatch.delenv("GENGAR_ALLOW_PRIVATE_URLS", raising=False)
    ...
    def test_env_var_true(self, monkeypatch):
        """GENGAR_ALLOW_PRIVATE_URLS=true enables the toggle."""
        monkeypatch.setenv("GENGAR_ALLOW_PRIVATE_URLS", "true")
        assert _global_allow_private_urls() is True

    def test_env_var_1(self, monkeypatch):
        """GENGAR_ALLOW_PRIVATE_URLS=1 enables the toggle."""
        monkeypatch.setenv("GENGAR_ALLOW_PRIVATE_URLS", "1")
        assert _global_allow_private_urls() is True

    def test_env_var_yes(self, monkeypatch):
        """GENGAR_ALLOW_PRIVATE_URLS=yes enables the toggle."""
        monkeypatch.setenv("GENGAR_ALLOW_PRIVATE_URLS", "yes")
        assert _global_allow_private_urls() is True

    def test_env_var_false(self, monkeypatch):
        """GENGAR_ALLOW_PRIVATE_URLS=false keeps it disabled."""
        monkeypatch.setenv("GENGAR_ALLOW_PRIVATE_URLS", "false")
        assert _global_allow_private_urls() is False
...
class TestAllowPrivateUrlsIntegration:
    ...
    def test_benchmark_ip_allowed_when_toggle_on(self, monkeypatch):
        ...
        with patch("socket.getaddrinfo", return_value=[
            ...
            assert is_safe_url("https://github.com/jamesfincher") is True
