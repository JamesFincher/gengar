...
# =============================================================================
# CANONICAL_PROVIDERS (gengar model picker)
# =============================================================================
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in GENGAR_OVERLAYS
        overlay = GENGAR_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubDoctor:
    """Verify gengar doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from hermes_cli.providers import GENGAR_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = GENGAR_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``gengar model`` routes it through the generic api_key_provider flow.
        """
        import inspect
