"""Tests for gengar claw commands."""
...
class TestFindMigrationScript:
    ...
    def test_finds_project_root_script(self, tmp_path):
        script = tmp_path / "openclaw_to_gengar.py"
...
class TestCmdMigrate:
    ...
    def test_dry_run_succeeds(self, tmp_path, capsys):
        ...
        fake_mod = ModuleType("openclaw_to_gengar")
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-gengar
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.gengar/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.gengar/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.gengar/migration/openclaw/20250312T120000",
        }
