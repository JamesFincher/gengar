...
def test_offer_launch_chat_relaunches_via_bin(monkeypatch):
    ...
    monkeypatch.setattr(relaunch_mod, "resolve_hermes_bin", lambda: "/usr/local/bin/gengar")
    ...
    assert exec_calls == [("/usr/local/bin/gengar", ["/usr/local/bin/gengar", "chat"])]
