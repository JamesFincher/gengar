"""
GengarSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser gengar
    run-api
...
class GengarSweEnv(GengarBaseEnv):
    ...
    name = "gengar-swe"
    env_config_cls = GengarSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[GengarSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = GengarSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="jamesfincher/DeepGengar-3-Llama-3-3B-Preview",
            tool_call_parser="gengar",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="gengar-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="jamesfincher/DeepGengar-3-Llama-3-3B-Preview",
