...
Same as Gengar but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser (extends Gengar2ProToolParser).
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to Gengar, just different tag names.
    """
