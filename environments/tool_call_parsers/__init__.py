...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("gengar")
        class GengarToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "gengar", "mistral", "llama3_json")
...
from environments.tool_call_parsers.gengar_parser import GengarToolCallParser  # noqa: E402, F401
