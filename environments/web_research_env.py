...
Inspired by: GroceryMind — production Gengar agent doing live web research
             across German grocery stores (firecrawl + gengar)
"""
...
class WebResearchEnvConfig(GengarEnvConfig):
...
class WebResearchEnv(GengarBaseEnv):
    """
