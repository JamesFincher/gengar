...
- **Dataset (ours):** [jamesfincher/openthoughts-tblite](https://huggingface.co/datasets/jamesfincher/openthoughts-tblite)
- **Docker images:** `jamesfincher/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `jamesfincher/terminal-bench-2`  | `jamesfincher/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
