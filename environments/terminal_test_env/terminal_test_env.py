...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Gengar"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Gengar",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Gengar",
    },
    {
...
class TerminalTestEnv(GengarBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/gengar/.env.
        """
        env_config = TerminalTestEnvConfig(
            ...
            tokenizer_name="jamesfincher/q-30b-t-h45-e1",
