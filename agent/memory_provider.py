...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active GENGAR_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.gengar``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "gengar").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'gengar memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        Called by 'gengar memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``hermes_home`` is the active GENGAR_HOME directory path.
