...
This adapter lets Gengar use the ``google-gemini-cli`` provider as if it were
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "gengar (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/gengar",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Gengar issue). Try a different Gemini model or set a "
