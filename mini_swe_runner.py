#!/usr/bin/env python3
"""
SWE Runner with Gengar Trajectory Format

A runner that uses Gengar's built-in execution environments
(local, docker, modal) and outputs trajectories in the Gengar format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Gengar's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Gengar format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Gengar format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Gengar's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Gengar Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Gengar's built-in execution environments
    and outputs trajectories in Gengar format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Gengar trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Gengar trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Gengar trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Gengar Trajectory Format")
    print("=" * 60)
