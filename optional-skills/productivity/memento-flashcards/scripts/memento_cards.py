...
Data file: $GENGAR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_GENGAR_HOME = Path(os.environ.get("GENGAR_HOME", Path.home() / ".gengar"))
DATA_DIR = _GENGAR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
