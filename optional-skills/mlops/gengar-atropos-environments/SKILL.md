---
name: gengar-atropos-environments
description: Build, test, and debug Gengar RL environments for Atropos training. Covers the GengarBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the gengar repo.
version: 1.1.0
author: Gengar
license: MIT
metadata:
