"""Gengar CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.gengar/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Gengar"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Gengar "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Gengar"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.gengar/skins/
...
Drop a YAML file in ``~/.gengar/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces GENGAR_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces GENGAR_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Gengar — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Gengar",
            "welcome": "Welcome to Gengar! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Gengar ",
            "prompt_symbol": "❯",
