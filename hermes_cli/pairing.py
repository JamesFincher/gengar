...
Usage:
    gengar pairing list              # Show all pending + approved users
    gengar pairing approve <platform> <code>  # Approve a pairing code
    gengar pairing revoke <platform> <user_id> # Revoke user access
    gengar pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle gengar pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: gengar pairing {list|approve|revoke|clear-pending}")
        print("Run 'gengar pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'gengar pairing list' to see pending codes.\n")
