...
One ``CDPSupervisor`` runs per Gengar ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "gengar-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://gengar-dialog-bridge.invalid/";
