...
import type { ScrollBoxHandle } from '@gengar/ink'
import { evictInkCaches } from '@gengar/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.GENGAR_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
