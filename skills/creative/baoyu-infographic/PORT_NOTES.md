...
|--------|----------|--------|
| Metadata namespace | `openclaw` | `gengar` |
...
| File operations | Bash commands | Gengar file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Gengar-specific adaptations.
