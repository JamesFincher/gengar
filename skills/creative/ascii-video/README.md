...
Built for [Gengar](https://github.com/jamesfincher/gengar). Usable in any coding agent. Canonical source lives here; synced to [`jamesfincher/gengar/skills/creative/ascii-video`](https://github.com/jamesfincher/gengar/tree/main/skills/creative/ascii-video) via PR.
