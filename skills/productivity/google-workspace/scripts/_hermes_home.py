"""Resolve GENGAR_HOME for standalone skill scripts.

Skill scripts may run outside the Gengar process (e.g. system Python,
...
instead of duplicating the ``GENGAR_HOME = Path(os.getenv(...))`` pattern.
"""
