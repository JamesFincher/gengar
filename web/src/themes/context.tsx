...
const STORAGE_KEY = "gengar-dashboard-theme";
...
const CUSTOM_CSS_STYLE_ID = "gengar-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-gengar-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-gengar-theme-font", "true");
