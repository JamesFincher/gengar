...
export const zh: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateGengar: "更新 Gengar",
    updatingGengar: "正在更新 Gengar…",
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 Gengar 插件（对齐 `gengar plugins` CLI）。",
    ...
    removeConfirm: "从 ~/.gengar/plugins/ 删除此插件？",
    removeHint: "仅可移除用户安装在 ~/.gengar/plugins 下的插件。",
  ...
  skills: {
    ...
    categories: "分类",
    filters: "筛选",
    noSkills: "未找到技能。技能从 ~/.gengar/skills/ 加载",
