 ...
 * `window.__GENGAR_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Gengar brand in the top bar
 ...
 *  `window.__GENGAR_PLUGINS__.registerSlot(...)`.
 *
